    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarritoDePrestamos", x => x.CarritoId);
                    table.ForeignKey(
                        name: "FK_CarritoDePrestamos_Elementos_ElementoId",
                        column: x => x.ElementoId,
                        principalTable: "Elementos",
                        principalColumn: "ElementoId");
                    table.ForeignKey(
                        name: "FK_CarritoDePrestamos_Usuarios_UsuarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarritoDePrestamos_ElementoId",
                table: "CarritoDePrestamos",
                column: "ElementoId");

            migrationBuilder.CreateIndex(
                name: "IX_CarritoDePrestamos_UsuarioId",
                table: "CarritoDePrestamos",
                column: "UsuarioId");

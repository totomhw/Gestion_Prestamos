...
namespace Gestion_Prestamos.Controllers
{
    public class AuthController : Controller
    {
        ...
        public AuthController(GestionPrestamosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Login(Usuario loginModel)
        {
            ...
            var user = await _context.Usuarios
                ...
                .FirstOrDefaultAsync(u => u.Nombre == loginModel.Nombre);
            ...
            if (user != null && VerifyPassword(loginModel.PasswordHash, user.PasswordHash))
            {
                ...
                return userRoleName switch
                {
                    ...
                    "Personal" => RedirectToAction("DashboardPersonal", "Home"),
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Register([Bind("Nombre,PasswordHash,Email")] Usuario usuario, int rolId)
        {
            if (ModelState.IsValid)
            {
